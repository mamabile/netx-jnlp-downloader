...
public class JNLPClassLoader extends URLClassLoader {
    ...
    private static Map urlToLoader = new Hashtable(); // never garbage collected!
    ...
    private List available = new Vector();
    ...
    void initializePermissions() {
        ...
        resourcePermissions = new Vector();
